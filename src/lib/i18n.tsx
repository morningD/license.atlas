...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "tracker.status-discussion": "Discussion",
    ...
    "tagdesc.review-discussion": "Discussed on the license-discuss list with license text, but never formally submitted for OSI review — the status will not change.",
  ...
  zh: {
    ...
    "tagdesc.review-discussion": "曾在 license-discuss 列表讨论并附许可证文本，但从未正式提交 OSI 审查——状态不会再变化。",
